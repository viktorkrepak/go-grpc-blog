...
type BlogServiceClient interface {
	CreateBlog(ctx context.Context, in *BlogItem, opts ...grpc.CallOption) (*BlogItem, error)
	ReadBlog(ctx context.Context, in *BlogId, opts ...grpc.CallOption) (*BlogItem, error)
	UpdateBlog(ctx context.Context, in *BlogItem, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *blogServiceClient) CreateBlog(ctx context.Context, in *BlogItem, opts ...grpc.CallOption) (*BlogItem, error) {
	out := new(BlogItem)
...
func (c *blogServiceClient) ReadBlog(ctx context.Context, in *BlogId, opts ...grpc.CallOption) (*BlogItem, error) {
	out := new(BlogItem)
...
func (c *blogServiceClient) UpdateBlog(ctx context.Context, in *BlogItem, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (x *blogServiceListBlogClient) Recv() (*BlogItem, error) {
	m := new(BlogItem)
...
type BlogServiceServer interface {
	CreateBlog(context.Context, *BlogItem) (*BlogItem, error)
	ReadBlog(context.Context, *BlogId) (*BlogItem, error)
	UpdateBlog(context.Context, *BlogItem) (*emptypb.Empty, error)
...
func (UnimplementedBlogServiceServer) CreateBlog(context.Context, *BlogItem) (*BlogItem, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateBlog not implemented")
}
func (UnimplementedBlogServiceServer) ReadBlog(context.Context, *BlogId) (*BlogItem, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReadBlog not implemented")
}
func (UnimplementedBlogServiceServer) UpdateBlog(context.Context, *BlogItem) (*emptypb.Empty, error) {
...
func _BlogService_CreateBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).CreateBlog(ctx, req.(*BlogItem))
	}
...
func _BlogService_UpdateBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).UpdateBlog(ctx, req.(*BlogItem))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (x *blogServiceListBlogServer) Send(m *BlogItem) error {
